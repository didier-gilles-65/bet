...
(function ($, window, document, undefined) {
    ...
    Thumbs.prototype.render = function () {
        ...
        if (!options.thumbImage) {
            ...
            for (i = 0; i < this._thumbcontent.length; ++i) {
                this._thumbcontent._thumbcontainer.append('<div class="wrapper-inner-tab-backgrounds-first"><div class="sim-button button28">' + this._thumbcontent[i].attr('alt') + '<button style="display:none"></button></div></div>');
            }
        }
    };
